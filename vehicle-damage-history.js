// Vehicle Damage History System
// This file manages the damage history for all vehicles in the fleet
...
class VehicleDamageHistory {
    ...
    addDamageEntry(vehicleId, damageData) {
        ...
        const entry = {
            ...
            photoType: damageData.photoType || 'camera', // 'camera' or 'upload'
    ...
    // Export damage history for GitHub
    exportDamageHistory() {
        return {
    ...
    // Import damage history from GitHub
    ...
    // Clear all damage history (for testing/reset purposes)
    clearAllHistory() {
        this.damageHistory = {};
        this.saveDamageHistory();
    }
